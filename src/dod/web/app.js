...
\f\r]`,E=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,fe=/-->/g,pe=/>/g,D=RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),me=/'/g,he=/"/g,ge=/^(?:script|style|textarea|title)$/i,_e=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),O=_e(1),k=_e(2),A=Symbol.for(`lit-noChange`),j=Symbol.for(`lit-nothing`),ve=new WeakMap,M=S.createTreeWalker(S,129);function ye(e,t){if(!ue(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return oe===void 0?t:oe.createHTML(t)}var be=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=E;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===E?c[1]===`!--`?o=fe:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=D):(ge.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=D):o=pe:o===D?c[0]===`>`?(o=i??E,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?D:c[3]===`"`?he:me):o===he||o===me?o=D:o===fe||o===pe?o=E:(o=D,i=void 0);let d=o===D&&e[t+1].startsWith(`/>`)?` `:``;a+=o===E?n+le:l>=0?(r.push(s),n.slice(0,l)+se+n.slice(l)+x+d):n+x+(l===-2?t:d)}return[ye(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},xe=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=be(t,n);if(this.el=e.createElement(l,r),M.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=M.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(se)){let t=u[o++],n=i.getAttribute(e).split(x),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ce:r[1]===`?`?we:r[1]===`@`?Te:F}),i.removeAttribute(e)}else e.startsWith(x)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(ge.test(i.tagName)){let e=i.textContent.split(x),t=e.length-1;if(t>0){i.textContent=b?b.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],C()),M.nextNode(),c.push({type:2,index:++a});i.append(e[t],C())}}}else if(i.nodeType===8)if(i.data===ce)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(x,e+1))!==-1;)c.push({type:7,index:a}),e+=x.length-1}a++}}static createElement(e,t){let n=S.createElement(`template`);return n.innerHTML=e,n}};function N(e,t,n=e,r){if(t===A)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=w(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=N(e,i._$AS(e,t.values),i,r)),t}var Se=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??S).importNode(t,!0);M.currentNode=r;let i=M.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new P(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ee(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=M.nextNode(),a++)}return M.currentNode=S,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},P=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=N(this,e,t),w(e)?e===j||e==null||e===``?(this._$AH!==j&&this._$AR(),this._$AH=j):e!==this._$AH&&e!==A&&this._(e):e._$litType$===void 0?e.nodeType===void 0?de(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==j&&w(this._$AH)?this._$AA.nextSibling.data=e:this.T(S.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=xe.createElement(ye(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Se(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=ve.get(e.strings);return t===void 0&&ve.set(e.strings,t=new xe(e)),t}k(t){ue(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(C()),this.O(C()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ae(e).nextSibling;ae(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},F=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=j,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=j}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=N(this,e,t,0),a=!w(e)||e!==this._$AH&&e!==A,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=N(this,r[n+o],t,o),s===A&&(s=this._$AH[o]),a||=!w(s)||s!==this._$AH[o],s===j?e=j:e!==j&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ce=class extends F{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===j?void 0:e}},we=class extends F{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==j)}},Te=class extends F{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=N(this,e,t,0)??j)===A)return;let n=this._$AH,r=e===j&&n!==j||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==j&&(n===j||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ee=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){N(this,e)}},De={M:se,P:x,A:ce,C:1,L:be,R:Se,D:de,V:N,I:P,H:F,N:we,U:Te,B:Ce,F:Ee},Oe=ie.litHtmlPolyfillSupport;Oe?.(xe,P),(ie.litHtmlVersions??=[]).push(`3.3.3`);var ke=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new P(t.insertBefore(C(),e),e,void 0,n??{})}return i._$AI(e),i},Ae=globalThis,I=class extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ke(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};I._$litElement$=!0,I.finalized=!0,Ae.litElementHydrateSupport?.({LitElement:I});var je=Ae.litElementPolyfillSupport;je?.({LitElement:I}),(Ae.litElementVersions??=[]).push(`4.2.2`);var L=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer(()=>{customElements.define(e,t)})},Me={attribute:!0,type:String,converter:v,reflect:!1,hasChanged:ne},Ne=(e=Me,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function R(e){return(t,n)=>typeof n==`object`?Ne(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function z(e){return R({...e,state:!0,attribute:!1})}var Pe={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Fe=e=>(...t)=>({_$litDirective$:e,values:t}),Ie=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},{I:Le}=De,Re=e=>e,ze=()=>document.createComment(``),B=(e,t,n)=>{let r=e._$AA.parentNode,i=t===void 0?e._$AB:t._$AA;if(n===void 0)n=new Le(r.insertBefore(ze(),i),r.insertBefore(ze(),i),e,e.options);else{let t=n._$AB.nextSibling,a=n._$AM,o=a!==e;if(o){let t;n._$AQ?.(e),n._$AM=e,n._$AP!==void 0&&(t=e._$AU)!==a._$AU&&n._$AP(t)}if(t!==i||o){let e=n._$AA;for(;e!==t;){let t=Re(e).nextSibling;Re(r).insertBefore(e,i),e=t}}}return n},V=(e,t,n=e)=>(e._$AI(t,n),e),Be={},Ve=(e,t=Be)=>e._$AH=t,He=e=>e._$AH,Ue=e=>{e._$AR(),e._$AA.remove()},We=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Ge=Fe(class extends Ie{constructor(e){if(super(e),e.type!==Pe.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=He(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,f=i.length-1,p=0,m=a.length-1;for(;d<=f&&p<=m;)if(i[d]===null)d++;else if(i[f]===null)f--;else if(s[d]===o[p])c[p]=V(i[d],a[p]),d++,p++;else if(s[f]===o[m])c[m]=V(i[f],a[m]),f--,m--;else if(s[d]===o[m])c[m]=V(i[d],a[m]),B(e,c[m+1],i[d]),d++,m--;else if(s[f]===o[p])c[p]=V(i[f],a[p]),B(e,i[d],i[f]),f--,p++;else if(l===void 0&&(l=We(o,p,m),u=We(s,d,f)),l.has(s[d]))if(l.has(s[f])){let t=u.get(o[p]),n=t===void 0?null:i[t];if(n===null){let t=B(e,i[d]);V(t,a[p]),c[p]=t}else c[p]=V(n,a[p]),B(e,i[d],n),i[t]=null;p++}else Ue(i[f]),f--;else Ue(i[d]),d++;for(;p<=m;){let t=B(e,c[m+1]);V(t,a[p]),c[p++]=t}for(;d<=f;){let e=i[d++];e!==null&&Ue(e)}return this.ut=o,Ve(e,c),A}}),Ke=class extends Ie{constructor(e){if(super(e),this.it=j,e.type!==Pe.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===j||e==null)return this._t=void 0,this.it=e;if(e===A)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};Ke.directiveName=`unsafeHTML`,Ke.resultType=1;var qe=Fe(Ke),Je=[`var(--dk-c1)`,`var(--dk-c2)`,`var(--dk-c3)`,`var(--dk-c4)`,`var(--dk-c5)`,`var(--dk-c6)`],H=e=>Je[((Number(e)||0)%6+6)%6];function U(e){return e==null?`–`:typeof e==`number`?Number.isFinite(e)?Number.isInteger(e)?e.toLocaleString():Math.abs(e)>=1e3?e.toLocaleString(void 0,{maximumFractionDigits:1}):e.toFixed(2):`–`:String(e)}function Ye(e){let t=Number(e)||0,n=Math.abs(t);return n>=1e9?`${(t/1e9).toFixed(1)}B`:n>=1e6?`${(t/1e6).toFixed(1)}M`:n>=1e3?`${(t/1e3).toFixed(1)}k`:Number.isInteger(t)?String(t):t.toFixed(2)}function Xe(e){return typeof e==`string`&&/^\d{4}-\d{2}-\d{2}/.test(e)?e.slice(0,10):String(e)}function W(e,t){let n=String(e);return n.length>t?`${n.slice(0,t-1)}…`:n}function Ze(e,t){let n=e.length,r=e.filter(e=>e!=null&&Number.isFinite(e));if(r.length<2)return O`<svg viewBox="0 0 ${240} ${46}"></svg>`;let i=Math.min(...r),a=Math.max(...r)-i||1,o=e=>4+e/(n-1)*232,s=e=>42-(e-i)/a*38,c=``,l=!1;return e.forEach((e,t)=>{if(e==null||!Number.isFinite(e)){l=!1;return}c+=`${l?`L`:`M`}${o(t).toFixed(1)},${s(e).toFixed(1)} `,l=!0}),O`<svg viewBox="0 0 ${240} ${46}" preserveAspectRatio="none">
    ...
    <text class="dk-tick" x=${i.l+s} y=${i.t+a*30+14} text-anchor="end">${r??`you`} →</text>`),O`<svg viewBox="0 0 ${820} ${o}">${u}</svg>`}function tt(e,t){let n={l:210,r:64,t:6,b:6},r=e.length,i=n.t+n.b+r*22,a=820-n.l-n.r,o=Math.max(...t.map(e=>Number(e)||0),0)||1,s=[];return t.forEach((t,r)=>{let i=n.t+r*22,c=Math.max(0,(Number(t)||0)/o*a);s.push(k`<text class="dk-tick" x=${n.l-8} y=${i+22/2+4} text-anchor="end">${W(Xe(e[r]),30)}</text>
      <rect x=${n.l} y=${i+3} width=${c} height=${16} fill=${H(0)}></rect>
      <text class="dk-cval" x=${n.l+c+6} y=${i+22/2+4}>${Ye(Number(t)||0)}</text>`)}),O`<svg viewBox="0 0 ${820} ${i}">${s}</svg>`}function nt(e){let t=e.kind??`line`,n=e.series??(e.values?[{name:e.label??``,values:e.values}]:[]),r=e.x??(n[0]?n[0].values.map((e,t)=>t):[]),i=n[0]?.values??[],a;return a=t===`spark`?Ze(i,H(e.color??0)):t===`diverging`?et(r,i,e.left,e.right):t===`hbar`?tt(r,i):$e(t===`bars`?`bar`:t===`stacked`?`stacked`:t===`area`?`area`:`line`,r,n,e.markers),O`<div class="dk-panel dk-chart ${t===`spark`?``:`dk-full`}">
    ${e.title?O`<div class="dk-l">${e.title}</div>`:``}${a}
  </div>`}var rt={nodeW:168,nodeH:44,colGap:76,rowGap:18,pad:18};function it(e,t=[]){let n=new Set(e.map(e=>e.id)),r=new Set,i=[],a=(e,t)=>{if(e===t||!n.has(e)||!n.has(t))return;let a=`${e} ${t}`;r.has(a)||(r.add(a),i.push({from:e,to:t}))};for(let e of t)a(e.from,e.to);for(let t of e)for(let e of t.dependsOn??[])a(e,t.id);return i}function at(e,t){let n=new Map,r=new Map;for(let t of e)n.set(t,0),r.set(t,[]);for(let e of t)r.get(e.from).push(e.to),n.set(e.to,n.get(e.to)+1);let i=new Map,a=e.filter(e=>n.get(e)===0);for(let e of a)i.set(e,0);let o=0;for(;a.length;){let e=[];for(let t of a){o++;let a=i.get(t);for(let o of r.get(t)){i.set(o,Math.max(i.get(o)??0,a+1));let t=n.get(o)-1;n.set(o,t),t===0&&e.push(o)}}a=e}if(o<e.length){let t=0;for(let e of i.values())t=Math.max(t,e);for(let n of e)i.has(n)||i.set(n,t+1)}return i}function ot(e,t,n,r){let i=(t.get(e)??[]).map(e=>n.get(e)).filter(e=>e!=null);return i.length?i.reduce((e,t)=>e+t,0)/i.length:r}var st=(e,t,n)=>{let r=e.get(t);r?r.push(n):e.set(t,[n])};function ct(e,t=[],n={}){let r={...rt,...n};if(!e.length)return{nodes:[],edges:[],width:0,height:0};let i=e.map(e=>e.id),a=it(e,t),o=at(i,a),s=1/0;for(let e of o.values())s=Math.min(s,e);if(s>0&&s!==1/0)for(let e of i)o.set(e,o.get(e)-s);let c=new Map,l=new Map,u=new Map,d=(e,t)=>st(u,t,e);for(let e of a){let t=o.get(e.from),n=o.get(e.to),r=`${e.from} ${e.to}`;if(l.set(r,[]),n-t>1){let i=e.from;for(let a=t+1;a<n;a++){let t=` d:${e.from}>${e.to}@${a}`;c.set(t,a),l.get(r).push(t),d(i,t),i=t}d(i,e.to)}else n>t&&d(e.from,e.to)}let f=new Map;for(let e of i)st(f,o.get(e),e);for(let[e,t]of c)st(f,t,e);let p=[...f.keys()].sort((e,t)=>e-t);for(let e of p){if(e===p[0])continue;let t=new Map((f.get(e-1)??[]).map((e,t)=>[e,t])),n=f.get(e),r=new Map(n.map((e,t)=>[e,t]));n.sort((e,n)=>ot(e,u,t,r.get(e))-ot(n,u,t,r.get(n))||r.get(e)-r.get(n))}let m=new Map,h=new Map,g=[];for(let e of p)f.get(e).forEach((t,n)=>{let i=r.pad+e*(r.nodeW+r.colGap),a=r.pad+n*(r.nodeH+r.rowGap);m.set(t,i),h.set(t,a),c.has(t)||g.push({id:t,rank:e,order:n,x:i,y:a,w:r.nodeW,h:r.nodeH})});let ee=e=>({x:m.get(e)+r.nodeW/2,y:h.get(e)+r.nodeH/2}),te=a.map(e=>{let t={x:m.get(e.from),y:h.get(e.from)},n={x:m.get(e.to),y:h.get(e.to)};return{from:e.from,to:e.to,x1:t.x+r.nodeW,y1:t.y+r.nodeH/2,x2:n.x,y2:n.y+r.nodeH/2,waypoints:(l.get(`${e.from} ${e.to}`)??[]).map(ee),back:o.get(e.from)>=o.get(e.to)}}),_=p[p.length-1],v=Math.max(...p.map(e=>f.get(e).length));return{nodes:g,edges:te,width:r.pad*2+(_+1)*r.nodeW+_*r.colGap,height:r.pad*2+v*r.nodeH+(v-1)*r.rowGap}}var lt={queued:{bucket:`idle`,satisfies:!1,notBegun:!0},pending:{bucket:`idle`,satisfies:!1,notBegun:!0},planning:{bucket:`active`,satisfies:!1,notBegun:!1},"in-cycle":{bucket:`active`,satisfies:!1,notBegun:!1},"in-progress":{bucket:`active`,satisfies:!1,notBegun:!1},green:{bucket:`good`,satisfies:!0,notBegun:!1},landed:{bucket:`good`,satisfies:!0,notBegun:!1},committed:{bucket:`good`,satisfies:!0,notBegun:!1},done:{bucket:`good`,satisfies:!0,notBegun:!1},blocked:{bucket:`warn`,satisfies:!1,notBegun:!1},"needs-hitl":{bucket:`warn`,satisfies:!1,notBegun:!1},error:{bucket:`err`,satisfies:!1,notBegun:!1}},ut={bucket:`idle`,satisfies:!1,notBegun:!1},dt=e=>lt[(e??``).toLowerCase()]??ut,ft=e=>dt(e).bucket,pt=e=>dt(e).satisfies,mt=e=>dt(e).notBegun;function ht(e,t){let n=new Map,r=new Map;for(let t of e)n.set(t,[]),r.set(t,[]);for(let e of t)!n.has(e.from)||!n.has(e.to)||(r.get(e.from).push(e.to),n.get(e.to).push(e.from));return{up:n,down:r}}function gt(e,t){let n=new Set,r=[e];for(;r.length;){let e=r.pop();for(let i of t.get(e)??[])n.has(i)||(n.add(i),r.push(i))}return n}function _t(e,t){return new Set([e,...gt(e,t.up),...gt(e,t.down)])}function vt(e,t){let n=new Set(e.filter(e=>pt(e.status)).map(e=>e.id)),r=new Set;for(let i of e)mt(i.status)&&(t.get(i.id)??[]).every(e=>n.has(e))&&r.add(i.id);return r}function G(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var yt={idle:`var(--dk-muted)`,active:`var(--dk-accent)`,good:`var(--dk-ok)`,warn:`var(--dk-warn)`,err:`var(--dk-err)`},bt=[[`idle`,`queued`],[`active`,`in progress`],[`good`,`done`],[`warn`,`blocked`],[`err`,`error`]],xt=e=>yt[ft(e)];function St(e){let t=[{x:e.x1,y:e.y1},...e.waypoints,{x:e.x2,y:e.y2}],n=`M${t[0].x},${t[0].y}`;for(let e=0;e<t.length-1;e++){let r=t[e],i=t[e+1],a=Math.max(24,Math.abs(i.x-r.x)/2);n+=` C${r.x+a},${r.y} ${i.x-a},${i.y} ${i.x},${i.y}`}return n}var K=class extends I{constructor(...e){super(...e),this.panel={type:`dag`},this.hover=null}createRenderRoot(){return this}nodes(){return(this.panel.nodes??[]).filter(e=>!!e&&e.id!=null)}legend(){return O`<div class="dk-legend dk-dag-legend">
      ${bt.map(([e,t])=>O`<span><i style="background:${yt[e]}"></i>${t}</span>`)}
      <span><i class="dk-dag-elig-key"></i>ready now</span>
    </div>`}render(){let e=this.nodes(),t=this.panel.title?O`<div class="dk-l">${this.panel.title}</div>`:``;if(!e.length)return O`<div class="dk-panel dk-full">${t}<div class="dk-muted">no units to show</div></div>`;let n=ct(e.map(e=>({id:e.id,dependsOn:e.dependsOn})),this.panel.edges),r=new Map(e.map(e=>[e.id,e])),i=ht(e.map(e=>e.id),n.edges),a=vt(e,i.up),o=this.hover?_t(this.hover,i):null,s=n.edges.map(e=>k`<path class=${`dk-dag-edge${o&&o.has(e.from)&&o.has(e.to)?` on`:``}${e.back?` back`:``}`} d=${St(e)} marker-end="url(#dk-arrow)"></path>`),c=n.nodes.map(e=>{let t=r.get(e.id),n=xt(t.status),i=a.has(e.id),s=o?!o.has(e.id):!1,c=t.action;return k`<g
    ...
    </div>`}};G([R({attribute:!1})],K.prototype,`panel`,void 0),G([R({attribute:!1})],K.prototype,`onAction`,void 0),G([z()],K.prototype,`hover`,void 0),K=G([L(`dk-dag`)],K);var q=class extends I{constructor(...e){super(...e),this.panel={type:`form`},this.values={},this.dirty=!1}createRenderRoot(){return this}willUpdate(e){if(e.has(`panel`)&&!this.dirty){let e={};for(let t of this.panel.fields??[])e[t.key]=t.value??(t.kind===`checkbox`?!1:``);this.values=e}}set(e,t){this.values={...this.values,[e]:t},this.dirty=!0}field(e){let t=this.values[e.key],n=O`<span class="dk-fl">${e.label??e.key}</span>`;return e.kind===`textarea`?O`<label class="dk-f dk-full"
        >${n}<textarea
    ...
    </div>`}};G([R({attribute:!1})],q.prototype,`panel`,void 0),G([R({attribute:!1})],q.prototype,`onAction`,void 0),G([z()],q.prototype,`values`,void 0),G([z()],q.prototype,`dirty`,void 0),q=G([L(`dk-form`)],q);var Ct={warm:`var(--dk-accent)`,cool:`var(--dk-c6)`,you:`var(--dk-c1)`,them:`var(--dk-c2)`,ok:`var(--dk-ok)`,err:`var(--dk-err)`},J=class extends I{constructor(...e){super(...e),this.panel={type:`wordcloud`},this.view=`cloud`,this.fkey=null}createRenderRoot(){return this}facets(){return(this.panel.facets??[]).filter(e=>e.terms&&e.terms.length)}current(){let e=this.facets();return e.find(e=>e.key===this.fkey)??e[0]}body(){let e=this.current();if(!e?.terms?.length)return O`<div class="dk-muted">no terms for this lens</div>`;let t=e.legend&&e.legend.length?O`<div class="dk-legend">
            ${e.legend.map(e=>O`<span><i style="background:${Ct[e.tone??``]??H(0)}"></i>${e.label}</span>`)}
          </div>`:``,n=[...e.terms].sort((e,t)=>(Number(t.weight)||0)-(Number(e.weight)||0));if(this.view===`bars`){let e=n.slice(0,22);return O`${t}${tt(e.map(e=>e.text),e.map(e=>Number(e.weight)||0))}`}let r=n.map(e=>Number(e.weight)||0),i=Math.max(...r,1),a=Math.min(...r,0),o=i-a||1;return O`${t}<div class="dk-cloud">
      ${n.slice(0,70).map((e,t)=>O`<span style="font-size:${12+Math.round(24*Math.sqrt(((Number(e.weight)||0)-a)/o))}px;color:${e.tone&&Ct[e.tone]?Ct[e.tone]:H(e.group==null?t:e.group)}" title=${String(e.weight??``)}>${e.text}</span>`)}
    ...
    </div>`}};G([R({attribute:!1})],J.prototype,`panel`,void 0),G([z()],J.prototype,`view`,void 0),G([z()],J.prototype,`fkey`,void 0),J=G([L(`dk-wordcloud`)],J);var wt=e=>O`<div class="dk-panel dk-full dk-sec">${e.title??``}</div>`,Tt=e=>O`
  ...
  </div>`,Et=e=>{let t=Number(e.max)||0,n=Number(e.value)||0,r=e.pct==null?t?100*n/t:0:Number(e.pct),i=e.text==null?t?`${U(n)} / ${U(t)} · ${r.toFixed(1)}%`:U(n):e.text,a=`${Math.max(0,Math.min(100,r)).toFixed(1)}%`;return O`
    <div class="dk-panel dk-full">
      <div class="dk-l">${e.label??``}</div>
      <div class="dk-bar"><i style="width:${a}"></i></div>
      <div class="dk-sub">${i}</div>
    </div>`},Dt=(e,t)=>e[t]===`right`||e[t]===`num`,Ot=e=>{let t=e.columns??[],n=e.rows??[],r=e.align??[];return O`
    <div class="dk-panel dk-full">
      ${e.title?O`<div class="dk-l">${e.title}</div>`:``}
      <table class="dk-tbl">
        <thead>
  ...
  </div>`,At=e=>{let t=e.text==null?(e.lines??[]).join(`
`):e.text;return O`
    <div class="dk-panel dk-full">
      ${e.title?O`<div class="dk-l">${e.title}</div>`:``}
      <pre class="dk-log">${t}</pre>
    </div>`},jt=e=>O`<div class="dk-panel"><span class="dk-pill ${e.tone??``}">${e.text??``}</span></div>`,Mt=e=>{let t=String(e.text??``).split(/\n\s*\n/).filter(e=>e.trim());return O`
    <div class="dk-panel dk-full dk-prose">
      ${e.title?O`<div class="dk-l">${e.title}</div>`:``}${t.map(e=>O`<p>${e.trim()}</p>`)}
    </div>`},Nt=e=>O`<div class="dk-panel dk-full">${qe(e.html??``)}</div>`,Pt=(e,t)=>O`
  <div class="dk-panel dk-full">
    ${e.title?O`<div class="dk-l">${e.title}</div>`:``}
    <div class="dk-acts">
  ...
  </div>`;function Ft(e,t){try{switch(e.type){case`section`:return wt(e);case`stat`:return Tt(e);case`progress`:return Et(e);case`chart`:return nt(e);case`table`:return Ot(e);case`kv`:return kt(e);case`log`:return At(e);case`badge`:return jt(e);case`prose`:return Mt(e);case`html`:return Nt(e);case`actions`:return Pt(e,t);case`button`:{let n=e;return Pt({type:`actions`,title:n.title,buttons:[{label:n.label,action:n.action,payload:n.payload,tone:n.tone}]},t)}case`form`:return O`<dk-form .panel=${e} .onAction=${t}></dk-form>`;case`wordcloud`:return O`<dk-wordcloud .panel=${e}></dk-wordcloud>`;case`dag`:return O`<dk-dag .panel=${e} .onAction=${t}></dk-dag>`;default:return O`<div class="dk-panel dk-full">
...
.dk-dag-sub{fill:var(--dk-muted);font-size:11px;font-family:ui-monospace,monospace}`;function Lt(){if(typeof document>`u`||document.getElementById(`dk-css`))return;let e=document.createElement(`style`);e.id=`dk-css`,e.textContent=It,(document.head??document.documentElement).appendChild(e)}var Rt=(e,t)=>typeof e.id==`string`?`id:${e.id}`:`ix:${t}`;function zt(e,t,n){Lt(),t.classList.add(`dk-root`);let r=e.panels??[];ke(O`
    ...
    `,t)}var Bt=250,Vt=3e3;function Ht(e,t){let n=Number(e?.refresh_ms);if(Number.isFinite(n)&&n>0)return Math.max(Bt,n);let r=Number(t);return Number.isFinite(r)&&r>0?Math.max(Bt,r):Vt}function Ut(e){let t=(typeof e.mount==`string`?document.querySelector(e.mount):e.mount)??document.body,{actionUrl:n}=e,r=e.onAction??(n?(e,t)=>{fetch(n,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:e,payload:t})}).catch(()=>{})}:void 0),i=!1,a,o=null,s=async()=>{if(!i){try{let n=await(await fetch(e.renderUrl,{cache:`no-store`})).json();if(i)return;o=n,zt(n,t,r)}catch{}a=setTimeout(()=>void s(),Ht(o,e.refreshMs))}};return s(),{stop:()=>{i=!0,a&&clearTimeout(a)}}}var Y=e=>e.status===`live`;function X(e){if(e.state===`starting`)return{word:`starting…`,cls:`starting`};if(e.state===`unhealthy`)return{word:`unhealthy`,cls:`unhealthy`};if(Y(e))return{word:`live`,cls:`live`};let t=e.last_stop_reason;return t&&t.kind===`crash`?{word:`crashed${t.exit==null?``:` (exit ${t.exit})`}`,cls:`crash`}:t&&t.kind===`port-busy`?{word:`port busy`,cls:`crash`}:{word:`stopped`,cls:`stopped`}}var Wt=e=>!Y(e)&&(e.cmd?.length??0)>0,Gt=e=>Y(e)&&!!e.controllable&&e.stop!==`leave`,Kt={start:`starting…`,stop:`stopping…`,restart:`restarting…`},qt=e=>Kt[e]??Kt.start,Z=class extends I{constructor(...e){super(...e),this.entry=null,this.pending=new Map,this.mountSpec=e=>Ut(e),this.framed=null,this.handle=null}createRenderRoot(){return this}emit(e,t){this.dispatchEvent(new CustomEvent(`action`,{detail:{verb:e,id:t},bubbles:!0,composed:!0}))}pendingBtn(e){let t=this.pending.get(e.id);return t?O`<button class="btn pending" disabled>${qt(t)}</button>`:null}stopMount(){this.handle&&=(this.handle.stop(),null)}disconnectedCallback(){super.disconnectedCallback(),this.stopMount()}updated(){let e=this.entry,t=e?`${e.id}:${e.state??``}:${e.render??``}`:null;if(t!==this.framed&&(this.framed=t,this.stopMount(),e&&Y(e)&&e.render===`spec`)){let t=this.querySelector(`#dkhost`);t&&(this.handle=this.mountSpec({renderUrl:`/api/render?id=${encodeURIComponent(e.id)}`,mount:t,onAction:(t,n)=>this.dispatchEvent(new CustomEvent(`spec-action`,{detail:{id:e.id,action:t,payload:n},bubbles:!0,composed:!0}))}))}}head(e){let t=X(e);return O`<div class="dhead">
      ...
      </div>`}render(){let e=this.entry;return e?O`${this.head(e)}<div class="body">${this.body(e)}</div>`:O`<div class="empty">Select a project on the left.</div>`}};G([R({attribute:!1})],Z.prototype,`entry`,void 0),G([R({attribute:!1})],Z.prototype,`pending`,void 0),Z=G([L(`dod-detail`)],Z);var Q=class extends I{constructor(...e){super(...e),this.entries=[],this.selected=null,this.pending=new Map,this.dragId=null}createRenderRoot(){return this}emit(e,t){this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}button(e){let t=this.pending.get(e.id);return t?O`<button class="btn pending" disabled>${qt(t)}</button>`:Gt(e)?O`<button
        class="btn stop"
      ...
      ></dod-detail>
    `}};G([z()],$.prototype,`entries`,void 0),G([z()],$.prototype,`selected`,void 0),G([z()],$.prototype,`pending`,void 0),$=G([L(`dod-app`)],$);function Yt(t=document.body){let n=document.createElement(`dod-app`);return n.api=new e(window.TOKEN??``),t.appendChild(n),n.start(),n}Yt()})();